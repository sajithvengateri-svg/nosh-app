...
/** WA Department of Health compliance config — Food Act 2008 (WA) */
export const WA_DOH_CONFIG: ComplianceFrameworkConfig = deriveFramework({
  id: "wa_doh",
  regionId: "au",
  locale: "en-AU",
  labels: {
    frameworkName: "WA Food Safety Compliance",
    frameworkShort: "WA DOH",
    licenceLabel: "Food Business Registration Number",
    licenceFieldKey: "bcc_licence_number",
    supervisorRole: "Food Safety Supervisor",
    certBody: "Department of Health WA",
    assessmentTitle: "Self-Assessment",
    assessmentSubtitle: "WA Food Safety Standards Checklist",
    accentColor: "#D97706",
  },
  features: {
    hasSupervisors: true,
  ...
  assessmentFrameworkFilter: "wa_doh",
  wizardSteps: [
    {
      key: "licence", title: "Food Business Registration",
      subtitle: "Enter your WA food business registration details",
      fields: [
        { key: "bcc_licence_number", label: "Registration Number", type: "text", required: true, placeholder: "e.g. WA-12345" },
    ...
    },
    {
      ...
      subtitle: "Appoint a Food Safety Supervisor under WA Food Act 2008",
      fields: [
