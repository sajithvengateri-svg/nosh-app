...
-- Part 1: Add store_mode column to signup_events
ALTER TABLE public.signup_events ADD COLUMN IF NOT EXISTS store_mode text DEFAULT NULL;

-- Part 2: Update handle_new_user to read store_mode from metadata and set it on the org
...
-- Part 3: Update handle_new_signup_event to write store_mode
