...
const lifestyleImages = [
  { src: cupcakesImg, alt: "Arabic sweets and baklava", accent: "amber" },
  { src: pantryImg, alt: "Organised pantry with Gulf spices", accent: "teal" },
  { src: bakesImg, alt: "Fresh flatbreads and sambousek", accent: "amber" },
  { src: macaronsImg, alt: "Gulf dessert selection", accent: "teal" },
];

const AUTH_SOURCE = "gcc_home_cook";
...
const GCCHomeCookLanding = () => {
  useSEO(SEO["/home-cook-gcc"]);
  const { sectionMap, isVisible, isLoading } = useGCCHomeCookLandingSections();
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 via-teal-50/30 to-white dark:from-neutral-950 dark:via-neutral-900 dark:to-neutral-950">
      {/* Nav */}
      <header className="sticky top-0 z-50 bg-white/80 dark:bg-neutral-950/80 backdrop-blur-lg border-b border-amber-100 dark:border-neutral-800">
        <div className="max-w-5xl mx-auto flex items-center justify-between px-6 py-4">
          <Link to="/home-cook-gcc" className="flex items-center gap-2 cursor-pointer">
      ...
      <section className="max-w-5xl mx-auto px-6 py-16">
        <motion.div {...fadeUp} className="text-center mb-10">
          ...
          <p className="mt-2 text-muted-foreground">The tech the pros use — made easy for your Gulf kitchen.</p>
        </motion.div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {featuresContent.map((f: any, i: number) => {
              ...
              return (
                ...
                >
                  <Card className={`h-full rounded-2xl border-${isAmber ? "amber" : "teal"}-100 dark:border-neutral-800 hover:shadow-lg transition-shadow`}>
                ...
                <motion.div key={i} {...fadeUp} transition={{ delay: i * 0.1 }}>
                  <Card className="h-full border-dashed border-amber-200 dark:border-neutral-700 opacity-80 rounded-2xl">
                    <CardContent className="p-6 text-center">
                      ...
                      <Badge variant="secondary" className="mt-3 text-[10px] bg-teal-100 text-teal-700 dark:bg-teal-900/30 dark:text-teal-400">Coming Soon</Badge>
                    </CardContent>
                  </Card>
                </motion.div>
              );
      ...
      {isVisible("money_tracker") && moneyTracker && (
        <section className="max-w-5xl mx-auto px-6 py-16">
          <motion.div {...fadeUp} className="bg-gradient-to-br from-amber-50 to-teal-50 dark:from-neutral-900 dark:to-neutral-800 rounded-3xl p-8 sm:p-12 text-center">
      ...
      {isVisible("solo_team") && soloTeam && (
        <section className="max-w-5xl mx-auto px-6 py-16 text-center">
          <motion.div {...fadeUp}>
            <Users2 className="w-10 h-10 text-teal-500 mx-auto mb-4" />
      ...
      <CrossMarketFooter region="gcc" current="homecook" />
      ...
      <footer className="border-t border-amber-100 dark:border-neutral-800 py-8">
        <div className="max-w-5xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-muted-foreground">ChefOS Home — GCC</span>
          </div>
          <div className="flex items-center gap-3">
...
export default GCCHomeCookLanding;
