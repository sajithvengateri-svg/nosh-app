...
export default function NoshConsumerLanding() {
  return (
    <div className="min-h-screen" style={{ background: "#FBF6F8" }}>
      ...
      {/* ── G. DOWNLOAD APP ───────────────────────────── */}
      <section id="download" className="py-24 md:py-32 px-4">
        <FadeUp>
          <div
          ...
          >
            ...
            <p className="mt-3 text-base" style={{ color: "#7A6B75" }}>
              Download Prep Mi and start cooking smarter today.
            </p>
            <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-4">
              <a
                ...
                className="px-8 py-3 rounded-full text-sm font-semibold text-white hover:opacity-90 transition-all inline-flex items-center gap-2"
                style={{ background: "linear-gradient(135deg, #D94878, #C13B68)" }}
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-8 py-3 rounded-full text-sm font-semibold border transition-all hover:bg-white/30 inline-flex items-center gap-2"
                style={{ borderColor: "#D94878", color: "#D94878" }}
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor"><path d="M3.18 23.75a1.94 1.94 0 0 1-.69-1.47V1.72A1.86 1.86 0 0 1 3.27.23l10.9 11.89L3.18 23.75zm15.3-8.66l-3.22-3.21 3.22-3.21 3.63 2.05a1.35 1.35 0 0 1 0 2.38l-3.63 2zm-4.4-3.21L5.05 2.35l12.47 7.04-3.44 2.49zm0 0l3.44 2.49L5.05 21.46l9.03-9.58z"/></svg>
                Google Play
              </a>
            </div>
            <p className="mt-4 text-xs" style={{ color: "#A89DA3" }}>
