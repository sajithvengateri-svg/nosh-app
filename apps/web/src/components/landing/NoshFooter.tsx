      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-12">
          ...
          >
            ...
            <div>
              <p className="text-sm font-bold" style={{ color: "#2A1F2D" }}>Prep Mi for Foodies</p>
          ...
          >
            ...
            <div>
              <p className="text-sm font-bold" style={{ color: "#2A1F2D" }}>Prep Mi for Vendors</p>
        ...
        <div className="text-center space-y-3">
          <p className="text-xl font-bold tracking-[6px]" style={{ color: "#D94878" }}>Prep Mi</p>
