...
export const useBevCalcStore = create<BevCalcState>()(
  persist(
    (set) => ({
      mode: "reverse",
      sellPrice: 0,
      ...
      reset: () => set({ mode: "reverse", sellPrice: 0, targetPercent: 22, actualCost: 0, servings: 1 }),
    }),
    { name: "bevos-calc-state" }
  )
);
