...
import { useBevInduction } from "@/hooks/useBevInduction";
import { useState } from "react";

const BevInductionTracker = () => {
  const {
  ...
  const renderStep = (step: typeof steps[0]) => (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <span className={`text-sm block ${step.done ? "line-through" : "font-medium"}`}>{step.label}</span>
...
export default BevInductionTracker;
