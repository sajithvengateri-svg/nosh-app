...
import { LayoutDashboard, CalendarDays, Clock, DollarSign, Users } from "lucide-react";
...
const items = [
  ...
  { label: "People", path: "/labour/people", icon: Users },
];

const LabourBottomNav = ({ className }: { className?: string }) => {
